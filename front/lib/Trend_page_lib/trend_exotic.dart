...
class Trend_exotic extends StatefulWidget {
  const Trend_exotic({Key? key}) : super(key: key);

  @override
  _trend_exotic createState() => _trend_exotic();
}

class _trend_exotic extends State<Trend_exotic> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("TOP EXOTIC", style: TextStyle(fontSize: 18, color: Color.fromARGB(255, 0, 0, 0), fontFamily: 'Font'),),
      ),
                      ...
                      child: Container(
                        ...
                        children: <Widget> [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/exotic.png', // Replace with the path to your local image asset
