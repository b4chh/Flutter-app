    ...
    return Scaffold(
      ...
      Padding(
        ...
        child: Column(
          ...
          children: <Widget> [
            Text('Trouvez votre compte', style: TextStyle(fontSize: 30, color: Color.fromARGB(255, 255, 255, 255)),),
            const SizedBox(height: 10),
            Text('Entrez votre adresse e-mail pour nous aidez à vous retrouver', style: TextStyle(fontSize: 15, color: Color.fromARGB(255, 255, 255, 255)),),
