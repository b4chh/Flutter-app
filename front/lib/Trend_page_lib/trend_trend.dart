...
class Trend_trend extends StatefulWidget {
  const Trend_trend({Key? key}) : super(key: key);

  @override
  _Trendtrend createState() => _Trendtrend();
}

class _Trendtrend extends State<Trend_trend> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("TOP TRENDING", style: TextStyle(fontSize: 18, color: Color.fromARGB(255, 0, 0, 0), fontFamily: 'Font'),),
      ),
                    ...
                    child: Padding(
                      ...
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                          color: Color.fromARGB(255, 220, 226, 249),
                        ...
                        children: <Widget> [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/bag.png', // Replace with the path to your local image asset
