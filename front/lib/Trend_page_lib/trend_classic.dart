...
class Trend_classic extends StatefulWidget {
  const Trend_classic({Key? key}) : super(key: key);

  @override
  _Trend_Classic createState() => _Trend_Classic();
}

class _Trend_Classic extends State<Trend_classic> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("TOP CLASSIC", style: TextStyle(fontSize: 18, color: Color.fromARGB(255, 0, 0, 0), fontFamily: 'Font'),),
      ),
                      ...
                      child: Container(
                        ...
                        children: <Widget> [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/classic.png', // Replace with the path to your local image asset
