...
class Trend_streetwear extends StatefulWidget {
  const Trend_streetwear({Key? key}) : super(key: key);

  @override
  _Trend_street createState() => _Trend_street();
}

class _Trend_street extends State<Trend_streetwear> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text("TOP STREETWEAR", style: TextStyle(fontSize: 18, color: Color.fromARGB(255, 0, 0, 0), fontFamily: 'Font'),),
      ),
                      ...
                      child: Container(
                        ...
                        children: <Widget> [
                          ClipRRect(
                            ...
                            child: Image.asset(
                              'assets/street.png', // Replace with the path to your local image asset
